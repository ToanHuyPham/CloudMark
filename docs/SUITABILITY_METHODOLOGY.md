...
- **Web & App Hosting:** CPU/RAM, HTTPS API throughput/success/P95, and
  directional network throughput/latency; dynamic runtime, upstreams,
  HTTP/2/3, WAF, CDN, autoscaling, and public TLS trust remain limitations.
...
- **Database Management:** CPU/RAM, durable synchronous storage, PostgreSQL
  durable transaction TPS/latency/failures, and network latency; tail latency,
  replication, recovery, other engines, and managed services remain
  limitations.
