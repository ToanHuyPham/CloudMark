...
DATABASE_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "postgres-peer-standard": {
        ...
        "description": "Concurrency scaling, durable transactions, connection churn, fixed-count P50/P95/P99/P99.9 transaction latency, and Generator CPU validity against an isolated PostgreSQL dataset.",
        "estimated_minutes": 14,
        "requires_agents": 2,
        "engine": "postgresql",
        "scale_factor": 50,
...
WEB_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "web-peer-standard": {
        ...
        "description": "HTTP/TLS concurrency curves, connection churn, static transfer, a bundled dynamic application behind Nginx, Generator CPU headroom, and fixed HTTP/2 negotiation evidence.",
        ...
        "jobs": [
            ...
            {"name": "http-dynamic-c1", "scheme": "http", "path": "/api/v2/dynamic", "concurrency": 1, "duration": 30, "warmup": 3, "keep_alive": True},
            {"name": "http-dynamic-c16", "scheme": "http", "path": "/api/v2/dynamic", "concurrency": 16, "duration": 40, "warmup": 3, "keep_alive": True},
            {"name": "http-dynamic-c64", "scheme": "http", "path": "/api/v2/dynamic", "concurrency": 64, "duration": 45, "warmup": 3, "keep_alive": True},
        ],
        "protocol_probes": [
...
ASSESSMENT_DOMAINS: list[dict[str, Any]] = [
    ...
    {"id": "web", "label": "Web, API & TLS", "status": "partial", "summary": "Guarded two-Agent static and reverse-proxied dynamic HTTP/TLS workloads, Generator headroom, tail latency, transfer, and HTTP/2 negotiation evidence available"},
    {"id": "database", "label": "Database & Cache", "status": "partial", "summary": "Guarded two-Agent PostgreSQL throughput, fixed-count transaction tail latency, Generator validity, and cleanup available; MySQL/MariaDB, Redis, replication, and recovery pending"},
