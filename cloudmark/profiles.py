...
SCENARIOS: list[dict[str, Any]] = [
    ...
    {"id": "web-app", "label": "Web & App Hosting", "status": "partial", "primary": "web", "coverage": "Static and packaged dynamic HTTP/TLS serving plus fixed HTTP/2 multiplexing evidence; database-backed applications pending"},
    {"id": "dev-test", "label": "Dev & Test", "status": "roadmap", "primary": "compute", "coverage": "Compute profile required"},
    {"id": "database", "label": "Database Management", "status": "partial", "primary": "database", "coverage": "PostgreSQL, Redis, and MySQL/MariaDB transaction, cache, checkpoint, and logical recovery evidence"},
